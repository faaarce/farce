...
const Masthead: FC = () => (
  <>
    {/* Top bar */}
    <div className={`${rule} pt-2.5 pb-1.5 flex flex-wrap justify-between items-baseline gap-1`}>
      <span className={lbl}>VOL. I · NO. 1</span>
      <span className={`${lbl} hidden sm:inline`}>JAKARTA, INDONESIA</span>
    ...
    <div className="text-center pt-5 pb-1.5">
      ...
      <div className="hidden sm:flex justify-center items-center gap-4 pt-1">
      ...
      <div className="sm:hidden pt-1">
        <span className={`${lbl} !text-[7px]`}>
          MOHAMMAD FARIS ARIE PRASETYO · SOFTWARE ENGINEER
        </span>
      </div>
    </div>
